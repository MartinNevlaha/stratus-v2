...
func TestAnalyzeMetrics(t *testing.T) {
	...
	patterns, err := database.ListInsightPatterns("", "", 0, 100)
	if err != nil {
...
func TestAnalyzeMetricsIdempotency(t *testing.T) {
	...
	patternsAfterFirst, err := database.ListInsightPatterns("", "", 0, 100)
	if err != nil {
		t.Fatalf("ListInsightPatterns failed after first run: %v", err)
	}
	...
	patternsAfterSecond, err := database.ListInsightPatterns("", "", 0, 100)
	if err != nil {
		t.Fatalf("ListInsightPatterns failed after second run: %v", err)
	}
...
func TestAnalyzeMetricsLowSuccessRate(t *testing.T) {
	...
	patterns, err := database.ListInsightPatterns("quality", "", 0, 100)
	if err != nil {
		t.Fatalf("ListInsightPatterns failed: %v", err)
	}
...
func TestAnalyzeMetricsHighSuccessRate(t *testing.T) {
	...
	patterns, err := database.ListInsightPatterns("success", "", 0, 100)
	if err != nil {
		t.Fatalf("ListInsightPatterns failed: %v", err)
	}
