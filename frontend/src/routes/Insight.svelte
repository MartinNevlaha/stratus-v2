<script lang="ts">
	...
	async function loadDashboard() {
		try {
			const res = await fetch('/api/insight/dashboard')
	...
	async function loadPatterns() {
		try {
			...
			const res = await fetch(`/api/insight/patterns?${params}`)
	...
	async function loadAnalyses() {
		try {
			const res = await fetch('/api/insight/analyses?limit=10')
	...
	async function loadProposals() {
		try {
			...
			const res = await fetch(`/api/insight/proposals?${params}`)
	...
	async function loadAgentScorecards() {
		try {
			...
			const res = await fetch(`/api/insight/scorecards/agents?${params}`)
	...
	async function loadWorkflowScorecards() {
		try {
			...
			const res = await fetch(`/api/insight/scorecards/workflows?${params}`)
	...
	async function triggerScorecardComputation() {
		try {
			const res = await fetch('/api/insight/scorecards/compute', { method: 'POST' })
	...
	async function loadRoutingRecommendations() {
		try {
			const res = await fetch('/api/insight/routing/recommendations?limit=50')
	...
	async function triggerRoutingAnalysis() {
		try {
			const res = await fetch('/api/insight/routing/analyze', { method: 'POST' })
	...
	async function loadProposalDetail(id: string) {
		try {
			const res = await fetch(`/api/insight/proposals/${id}`)
	...
	async function updateProposalStatus(newStatus: string, requireReason: boolean = false) {
		...
		try {
			actionLoading = true
			const res = await fetch(`/api/insight/proposals/${selectedProposal.id}/status`, {
				method: 'PATCH',
	...
	async function triggerAnalysis() {
		try {
			const res = await fetch('/api/insight/trigger', { method: 'POST' })
