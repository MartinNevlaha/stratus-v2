...
The OpenClaw Dashboard provides a comprehensive interface for viewing and managing OpenClaw's autonomous improvement proposals. It offers visibility into detected patterns, generated proposals, and their lifecycle management.

**Important:** OpenClaw is **advisory only**. No automatic execution or system changes occur without human review and approval.
...
Shows recent OpenClaw analysis runs:
...
### PATCH /api/openclaw/proposals/:id/status
...
1. **Pattern Detected**: OpenClaw detects workflow failure cluster
...
The dashboard makes OpenClaw's intelligence **visible, understandable, and actionable** while maintaining safety and human oversight.
